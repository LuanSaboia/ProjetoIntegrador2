...
export function ModalMatch({ isOpen, onOpen, onClose, data }: ModalInfoProps){
    ...
    async function handleUpdate(){
        if(!dataPart || !horaPart || !localPart || !p1Part || !p2Part ||!playersTeam1 || !playersTeam2 ||
        !cardT1 || !cardT2 || !chuteT1 || !chuteT2 || !escanteioT1 || !escanteioT2 || !posseT1 ||
        !posseT2 || !selectedPlayersTeam1 || !selectedPlayersTeam2 || !momentGolTeam1 || !momentGolTeam2){
            return
        }
