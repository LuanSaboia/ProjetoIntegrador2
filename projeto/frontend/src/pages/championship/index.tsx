                            ...
                            <Link key={championship.id_comp} href={`/championship/${championship.id_comp}`}>
                                ...
                                >
                                    ...
                                    <Flex>
                                        ...
                                        <Text color={!championship.timeVencedor ? "green.300" : "red.300"} fontWeight="bold">
                                            {!championship.timeVencedor ? "Ativo" : "Finalizado" }
                                        </Text>
                                    </Flex>
                                </Flex>
                            </Link>
                            {!championship.situacao_comp ?
                                <Link key={championship.id_comp} href={`/match${!championship.timeVencedor ? '/next/' : '/'}/${championship.id_comp}`}>
                                    <Button ml={3}>Ver partidas</Button>
                                </Link>
                                :
                                <Link key={championship.id_comp} href={`/championship/${championship.quantidade_times_comp === 32 ? 'group' : 'match'}/${championship.id_comp}`}>
